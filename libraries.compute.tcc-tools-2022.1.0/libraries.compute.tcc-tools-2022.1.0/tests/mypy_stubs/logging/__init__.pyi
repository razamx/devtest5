...
class Formatter:
    converter: Any = ...
    datefmt: Any = ...
    def __init__(self, fmt: Optional[Any] = ..., datefmt: Optional[Any] = ..., style: str = ...) -> None: ...
...
def trace(msg: Any, *args: Any, **kwargs: Any) -> None: ...   # custom level
def success(msg: Any, *args: Any, **kwargs: Any) -> None: ... # custom level
def output(msg: Any, *args: Any, **kwargs: Any) -> None: ...  # custom level
