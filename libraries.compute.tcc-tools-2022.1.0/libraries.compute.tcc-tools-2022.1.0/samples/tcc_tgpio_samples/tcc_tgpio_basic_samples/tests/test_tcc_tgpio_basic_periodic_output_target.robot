...
${SAMPLE}              tcc_tgpio_basic_periodic_output
...
Run With Default Settings
    ...
    Run Command And Check Output Contain    ${cmd}    0    Start periodic output.    timeout=1min    on_timeout=kill
    [Tags]    NO_PRE_COMMIT
...
Wrong Device
    ${cmd}=    Set Variable    ${RUNNER} ${RUN_DURATION} ${TCC_RUN_PREFIX} ${SAMPLE} --device /nonexistent/device
