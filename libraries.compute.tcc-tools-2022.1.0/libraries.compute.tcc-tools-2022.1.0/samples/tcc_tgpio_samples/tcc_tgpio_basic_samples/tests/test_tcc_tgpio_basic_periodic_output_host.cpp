...
#include "tgpio_basic_periodic_output.c"
#undef main
...
class test_tcc_tgpio_basic_periodic_output : public Test
{
protected:
...
////////////////////////////////////////////////////////////////////////////////
TEST_F(test_tcc_tgpio_basic_periodic_output, parse_help_positive) {
    ::Args args {"--help"};
    ...
    EXPECT_EQ(sample_settings.period, TCC_NSEC_PER_SEC);
}

////////////////////////////////////////////////////////////////////////////////
// ERROR HANDLING TESTS
////////////////////////////////////////////////////////////////////////////////
TEST_F(test_tcc_tgpio_basic_periodic_output, wrong_device_open_negative) {
...
TEST_F(test_tcc_tgpio_basic_periodic_output, signal_generation_ioctl_negative) {
    int fake_fd = 123;
...
TEST_F (test_tcc_tgpio_basic_periodic_output, defaults_positive) {
    int fake_fd = 123;
    ::Args args {};
